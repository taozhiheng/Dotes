...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//Every line: the border right or bottom line to left or top distance in pixel
		//final: lineWidth -- the sum of each childWidth in the same row
		//final: lineHeight -- the max of each childHeight in the same row
        int lineWidth = 0;
        int lineHeight = 0;
